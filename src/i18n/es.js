export default {
  // App
  'app.subtitle': 'I Ching — El Libro de las Mutaciones',
  'theme.toggle': 'Cambiar tema',
  'theme.light': 'Modo claro',
  'theme.dark': 'Modo oscuro',

  // Question form
  'question.label': 'Concentra tu mente en la pregunta y escríbela a continuación',
  'question.placeholder': 'Escribe tu pregunta al oráculo...',
  'question.submit': 'Consultar el Oráculo',
  'question.or': 'o',
  'question.general': 'Consulta General',
  'question.yours': 'Tu pregunta:',

  // Coin toss
  'coins.count': 'Líneas generadas: {count} / 6',
  'coins.cast': 'Lanzar Monedas',
  'coins.casting': 'Lanzando...',
  'coins.line': '(Línea {num})',
  'coins.6': 'Yin Mutante',
  ...
  'hex.original': 'Hexagrama Original',
  'hex.transformed': 'Hexagrama Mutado',
  ...
  'history.empty': 'No hay consultas registradas.',
  'history.general': 'Consulta general',
  'history.loading': 'Cargando historial...',
  'history.serverError': 'No se pudo conectar al servidor. El historial requiere el servidor activo.',
